...
> **前置知识**：熟悉 rclcpp / DDS 基础概念；若不熟，请先阅读 [ros2_topic_communication_research](../../ros2-core/ros2_topic_communication_research/) 与 [ros2_rclcpp_core_research](../../ros2-core/ros2_rclcpp_core_research/)。
...
- [ros2_topic_communication_research](../../ros2-core/ros2_topic_communication_research/) — 通信基础（发布/订阅/序列化）
- [ros2_rclcpp_core_research](../../ros2-core/ros2_rclcpp_core_research/) — Executor / Node 设计
- [ros2_qos_research](../../ros2-core/ros2_qos_research/) — QoS 三层映射
- [ros2_service_discovery_research](../../ros2-core/ros2_service_discovery_research/) — SPDP / SEDP 发现协议
